...
function ContextCard({ context }: { context: Context }) { return <article className="calendar-row"><div><h3>{context.statement}</h3><p>{context.observationIds.length} observasi · {context.eventIds.length} event</p></div><span className="impact low">CONTEXT</span></article>; }
