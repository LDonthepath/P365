...
import type { DataQuality, Observation, ProviderHealth } from "@/lib/domain/types";
...
export function DashboardView({ data, sessionEmail }: { data: DashboardData; sessionEmail: string }) {
  ...
  const { macroNews, cryptoNews, calendarEvents, unavailableSources, observations, macroObservations, evidence, providerHealth } = data;
