...
export const MACRO_SERIES_REGISTRY = [
  ...
  { seriesId: "JTSJOL", subject: "Job Openings: Total Nonfarm", frequency: "MONTHLY", unit: "Level in Thousands", source: "FRED", domain: "MACRO", freshnessMs: 45 * DAY, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "JTSQUR", subject: "Quits: Total Nonfarm", frequency: "MONTHLY", unit: "Rate", source: "FRED", domain: "MACRO", freshnessMs: 45 * DAY, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "SAHMREALTIME", subject: "Real-time Sahm Rule Recession Indicator", frequency: "MONTHLY", unit: "Percentage Points", source: "FRED", domain: "MACRO", freshnessMs: 45 * DAY, revalidateSeconds: 12 * 60 * 60 },
