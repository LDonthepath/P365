...
export type MacroSeriesDefinition = {
   ...
   * The value is qualified per series; frequency alone does not select it.
   */
  freshnessMs: number;
...
const STANDARD_MONTHLY_CADENCE_TOLERANCE = 45 * DAY;
const LAGGED_MONTHLY_CADENCE_TOLERANCE = 65 * DAY;
...
export const MACRO_SERIES_REGISTRY = [
  ...
  { seriesId: "CPIAUCSL", subject: "Consumer Price Index for All Urban Consumers: All Items", frequency: "MONTHLY", unit: "Index 1982-1984=100", source: "FRED", domain: "MACRO", freshnessMs: STANDARD_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "CPILFESL", subject: "Consumer Price Index for All Urban Consumers: All Items Less Food and Energy", frequency: "MONTHLY", unit: "Index 1982-1984=100", source: "FRED", domain: "MACRO", freshnessMs: STANDARD_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "PCEPI", subject: "Personal Consumption Expenditures: Chain-type Price Index", frequency: "MONTHLY", unit: "Index 2017=100", source: "FRED", domain: "MACRO", freshnessMs: LAGGED_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "PCEPILFE", subject: "Personal Consumption Expenditures Excluding Food and Energy: Chain-type Price Index", frequency: "MONTHLY", unit: "Index 2017=100", source: "FRED", domain: "MACRO", freshnessMs: LAGGED_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "UNRATE", subject: "Unemployment Rate", frequency: "MONTHLY", unit: "Percent", source: "FRED", domain: "MACRO", freshnessMs: STANDARD_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "PAYEMS", subject: "All Employees, Total Nonfarm", frequency: "MONTHLY", unit: "Thousands of Persons", source: "FRED", domain: "MACRO", freshnessMs: STANDARD_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  ...
  { seriesId: "CCSA", subject: "Continued Claims (Insured Unemployment)", frequency: "WEEKLY", unit: "Number", source: "FRED", domain: "MACRO", freshnessMs: 14 * DAY, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "JTSJOL", subject: "Job Openings: Total Nonfarm", frequency: "MONTHLY", unit: "Level in Thousands", source: "FRED", domain: "MACRO", freshnessMs: LAGGED_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "JTSQUR", subject: "Quits: Total Nonfarm", frequency: "MONTHLY", unit: "Rate", source: "FRED", domain: "MACRO", freshnessMs: LAGGED_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
  { seriesId: "SAHMREALTIME", subject: "Real-time Sahm Rule Recession Indicator", frequency: "MONTHLY", unit: "Percentage Points", source: "FRED", domain: "MACRO", freshnessMs: STANDARD_MONTHLY_CADENCE_TOLERANCE, revalidateSeconds: 12 * 60 * 60 },
